...
node --max-old-space-size=14000 ./node_modules/.bin/snarkjs groth16 setup circuit.r1cs $1 circuit_final.zkey

# SKIPPED
# Contribute to the phase2 ceremony
# Just 1 contribution is enough
# node --max-old-space-size=14000 ./node_modules/.bin/snarkjs zkey contribute circuit_0000.zkey circuit_0001.zkey --name="1st Contributor Name" -v -e="some random text"
...
# node --max-old-space-size=14000 ./node_modules/.bin/snarkjs zkey beacon circuit_0001.zkey circuit_final.zkey 0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f 10 -n="Final Beacon phase2"

# Verify the final zkey
# node --max-old-space-size=14000 ./node_modules/.bin/snarkjs zkey verify circuit.r1cs $1 circuit_final.zkey
