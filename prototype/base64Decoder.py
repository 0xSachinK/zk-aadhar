...
def bits2Num(_in, n):
    # Consumes the output of num2bits
...
def decodeBase64(_in):
    ...
    while i < len(bits):
        _bits = bits[i:i+8]
        reveresed_bits = _bits[::-1]        # reverese the bits for input to bits2Num
        num = bits2Num(reveresed_bits, 8)
        out.append(num)
        i +=  8
    return out

# _in = [84,87,70,117,101,83,66,111,89,87,53,107,99,121,66,116,89,87,116,108,73,71,120,112,90,50,104,48,73,72,100,118,99,109,115,117]
